...
<div id="container" style="width:100%; height:100%; background:url(images/header_bg.jpg); background-repeat:repeat-x;">
  ...
  <div id="header" style="width:960px; height:75px; margin:0 auto; font-size:12px;">
    ...
    <!--登录信息-->
    <div id="info" style="color:#ffffff; width:500px; height:20px; margin-top:20px; float:right;text-align:right"><a href='Manage.asp'>网站首页</a>&nbsp;&nbsp;|&nbsp;<a href='#' target='_blank'>论坛</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#" target='_blank'>帮助</a>&nbsp;&nbsp;|&nbsp;&nbsp;<img src="images/fav00000.gif" align="absmiddle" border="0"><a href='' onClick="AddFavorite(window.location,document.title)">收藏本站</a></img>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="CF_Admin_Manage.asp?Action=adminlogout">退出</a> </div>
  </div>
  <!--导入部分div-->
      ...
      <div class="content">
        ...
        <div class="col">
          ...
          <div style="float:right">
            <p > <a target="_blank" style="color:red;text-decoration:underline" href="#">【<%=RsSet("SysTitle")%>】邮件营销官方权威数据分析工具，此刻激活还可免费试用！</a><img src="images/new00000.gif" border="0"> </p>
          </div>
          <!-- ********************************* current link end ********************************* -->
          <div class="clearing"></div>
          <div class="filters">
